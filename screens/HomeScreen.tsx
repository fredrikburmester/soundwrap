...
export default function HomeScreen({ navigation }: RootStackScreenProps<'Home'>) {
  ...
  return (
    <ScrollView style={{ paddingHorizontal: 18, backgroundColor: Colors.background, paddingTop: 18 }} contentInsetAdjustmentBehavior="automatic">
      <Card title="Play the game" style={{ backgroundColor: Colors.primary, shadowColor: Colors.primaryLight, shadowRadius: 5, shadowOpacity: 1, shadowOffset: { width: 0, height: 1 } }} description="Can you win?" onPress={() => navigation.navigate('Soundcheck')} />
